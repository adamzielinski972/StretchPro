...
const activities = [
  ...
  { label: 'Next Stretch', time: 5, image: require('./images/next.png'), index: '2 of 7' },
  { label: 'Pigeon', time: 30, image: require('./images/Pigeon.png'), index: '3 of 7' },
  ...
  { label: 'Next Stretch', time: 5, image: require('./images/next.png'), index: '3 of 7' },
  { label: 'Elbow Plank', time: 30, image: require('./images/Elbow-Plank.png'), index: '4 of 7' },
  { label: 'Next Stretch', time: 5, image: require('./images/next.png'), index: '4 of 7' },
  { label: 'Next Stretch', time: 5, image: require('./images/next.png'), index: '4 of 7' },
  { label: 'Cat Cow', time: 30, image: require('./images/Cat-Cow.png'), index: '5 of 7' },
  { label: 'Next Stretch', time: 5, image: require('./images/next.png'), index: '5 of 7' },
  { label: 'Next Stretch', time: 5, image: require('./images/next.png'), index: '5 of 7' },
  { label: 'Seated Twist', time: 30, image: require('./images/Seated-Twist.png'), index: '6 of 7' },
  ...
  { label: 'Next Stretch', time: 5, image: require('./images/next.png'), index: '6 of 7' },
  { label: 'Knees To Chest', time: 30, image: require('./images/Knees-To-Chest.png'), index: '7 of 7' },
];

const LowerBack6StretchScreen = ({ navigation }) => {
  ...
  const goBack = async () => {
    try {
      navigation.navigate('LowerBack6');
    } catch (error) {
...
export default LowerBack6StretchScreen;
