...
const activities = [
  { label: 'Cat Cow', time: 30, image: require('./images/Cat-Cow.png'), index: '1 of 8' },
  ...
  { label: 'Next Stretch', time: 5, image: require('./images/next.png'), index: '2 of 8' },
  { label: 'Lunge', time: 30, image: require('./images/Lunge.png'), index: '3 of 8' },
  ...
  { label: 'Next Stretch', time: 5, image: require('./images/next.png'), index: '3 of 8' },
  { label: 'Reverse Lunge', time: 30, image: require('./images/Reverse-Lunge.png'), index: '4 of 8' },
  ...
  { label: 'Next Stretch', time: 5, image: require('./images/next.png'), index: '4 of 8' },
  { label: 'Butterfly', time: 30, image: require('./images/Butterfly.png'), index: '5 of 8' },
  { label: 'Next Stretch', time: 5, image: require('./images/next.png'), index: '5 of 8' },
  { label: 'Next Stretch', time: 5, image: require('./images/next.png'), index: '5 of 8' },
  { label: 'Knees To Chest', time: 30, image: require('./images/Knees-To-Chest.png'), index: '6 of 8' },
  { label: 'Next Stretch', time: 5, image: require('./images/next.png'), index: '6 of 8' },
  { label: 'Next Stretch', time: 5, image: require('./images/next.png'), index: '6 of 8' },
  { label: 'Spinal Twist', time: 30, image: require('./images/Spinal-Twist.png'), index: '7 of 8' },
  { label: 'Switch Sides', time: 5, image: require('./images/swap.png'), index: '7 of 8' },
  { label: 'Switch Sides', time: 5, image: require('./images/swap.png'), index: '7 of 8' },
  { label: 'Spinal Twist', time: 30, image: require('./images/Spinal-Twist.png'), index: '7 of 8' },
  { label: 'Next Stretch', time: 5, image: require('./images/next.png'), index: '7 of 8' },
  { label: 'Next Stretch', time: 5, image: require('./images/next.png'), index: '7 of 8' },
  { label: 'Lying Figure Four', time: 30, image: require('./images/Lying-Figure-Four.png'), index: '8 of 8' },
...
const LowerBack1StretchScreen = ({ navigation }) => {
  ...
  const goBack = async () => {
    try {
      navigation.navigate('LowerBack1');
    } catch (error) {
...
export default LowerBack1StretchScreen;
