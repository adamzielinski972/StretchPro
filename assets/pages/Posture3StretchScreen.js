...
const activities = [
  { label: 'Crunch Hold', time: 15, image: require('./images/Crunch-Hold.png'), index: '1 of 10' },
  { label: 'Next Stretch', time: 5, image: require('./images/next.png'), index: '1 of 10' },
  { label: 'Next Stretch', time: 5, image: require('./images/next.png'), index: '1 of 10' },
  { label: 'Bridge', time: 15, image: require('./images/Bridge.png'), index: '2 of 10' },
  { label: 'Next Stretch', time: 5, image: require('./images/next.png'), index: '2 of 10' },
  { label: 'Next Stretch', time: 5, image: require('./images/next.png'), index: '2 of 10' },
  { label: 'Dead Bug', time: 15, image: require('./images/Dead-Bug.png'), index: '3 of 10' },
  ...
  { label: 'Next Stretch', time: 5, image: require('./images/next.png'), index: '3 of 10' },
  { label: 'Bridge Leg Lift', time: 15, image: require('./images/Bridge-Leg-Lift.png'), index: '4 of 10' },
  { label: 'Switch Sides', time: 5, image: require('./images/swap.png'), index: '4 of 10' },
  { label: 'Switch Sides', time: 5, image: require('./images/swap.png'), index: '4 of 10' },
  { label: 'Bridge Leg Lift', time: 15, image: require('./images/Bridge-Leg-Lift.png'), index: '4 of 10' },
  { label: 'Next Stretch', time: 5, image: require('./images/next.png'), index: '4 of 10' },
  { label: 'Next Stretch', time: 5, image: require('./images/next.png'), index: '4 of 10' },
  { label: 'Bicycle Crunch Hold', time: 15, image: require('./images/Bicycle-Crunch-Hold.png'), index: '5 of 10' },
  { label: 'Switch Sides', time: 5, image: require('./images/swap.png'), index: '5 of 10' },
  { label: 'Switch Sides', time: 5, image: require('./images/swap.png'), index: '5 of 10' },
  { label: 'Bicycle Crunch Hold', time: 15, image: require('./images/Bicycle-Crunch-Hold.png'), index: '5 of 10' },
  { label: 'Next Stretch', time: 5, image: require('./images/next.png'), index: '5 of 10' },
  { label: 'Next Stretch', time: 5, image: require('./images/next.png'), index: '5 of 10' },
  { label: 'Bird Dog', time: 15, image: require('./images/Bird-Dog.png'), index: '6 of 10' },
  ...
  { label: 'Next Stretch', time: 5, image: require('./images/next.png'), index: '6 of 10' },
  { label: 'Airplane', time: 15, image: require('./images/Airplane.png'), index: '7 of 10' },
  { label: 'Next Stretch', time: 5, image: require('./images/next.png'), index: '7 of 10' },
  { label: 'Next Stretch', time: 5, image: require('./images/next.png'), index: '7 of 10' },
  { label: 'Lying Side Leg Raise', time: 15, image: require('./images/Lying-Side-Leg-Raise.png'), index: '8 of 10' },
  { label: 'Switch Sides', time: 5, image: require('./images/swap.png'), index: '8 of 10' },
  { label: 'Switch Sides', time: 5, image: require('./images/swap.png'), index: '8 of 10' },
  { label: 'Lying Side Leg Raise', time: 15, image: require('./images/Lying-Side-Leg-Raise.png'), index: '8 of 10' },
  { label: 'Next Stretch', time: 5, image: require('./images/next.png'), index: '8 of 10' },
  { label: 'Next Stretch', time: 5, image: require('./images/next.png'), index: '8 of 10' },
  { label: 'Elbow Side Plank', time: 15, image: require('./images/Elbow-Side-Plank.png'), index: '9 of 10' },
  ...
  { label: 'Next Stretch', time: 5, image: require('./images/next.png'), index: '9 of 10' },
  { label: 'Hand Plank', time: 15, image: require('./images/Hand-Plank.png'), index: '10 of 10' },
];

const Posture3StretchScreen = ({ navigation }) => {
...
export default Posture3StretchScreen;
