...
const activities = [
  ...
  { label: 'Next Stretch', time: 5, image: require('./images/next.png'), index: '1 of 10' },
  { label: 'One Arm Hug', time: 15, image: require('./images/One-Arm-Hug.png'), index: '2 of 10' },
  ...
  { label: 'Next Stretch', time: 5, image: require('./images/next.png'), index: '2 of 10' },
  { label: 'Reverse Shoulder', time: 30, image: require('./images/Reverse-Shoulder.png'), index: '3 of 10' },
  { label: 'Next Stretch', time: 5, image: require('./images/next.png'), index: '3 of 10' },
  { label: 'Next Stretch', time: 5, image: require('./images/next.png'), index: '3 of 10' },
  { label: 'Overhead Tricep', time: 15, image: require('./images/Overhead-Tricep.png'), index: '4 of 10' },
  ...
  { label: 'Next Stretch', time: 5, image: require('./images/next.png'), index: '4 of 10' },
  { label: 'Wall Arms', time: 30, image: require('./images/Wall-Arms.png'), index: '5 of 10' },
  ...
  { label: 'Next Stretch', time: 5, image: require('./images/next.png'), index: '5 of 10' },
  { label: 'Forward Fold', time: 30, image: require('./images/Forward-Fold.png'), index: '6 of 10' },
  { label: 'Next Stretch', time: 5, image: require('./images/next.png'), index: '6 of 10' },
  { label: 'Next Stretch', time: 5, image: require('./images/next.png'), index: '6 of 10' },
  { label: 'Wall Pecs', time: 30, image: require('./images/Wall-Pecs.png'), index: '7 of 10' },
  { label: 'Switch Sides', time: 5, image: require('./images/swap.png'), index: '7 of 10' },
  { label: 'Switch Sides', time: 5, image: require('./images/swap.png'), index: '7 of 10' },
  { label: 'Wall Pecs', time: 30, image: require('./images/Wall-Pecs.png'), index: '7 of 10' },
  { label: 'Next Stretch', time: 5, image: require('./images/next.png'), index: '7 of 10' },
  { label: 'Next Stretch', time: 5, image: require('./images/next.png'), index: '7 of 10' },
  { label: 'Diver', time: 30, image: require('./images/Diver.png'), index: '8 of 10' },
  { label: 'Next Stretch', time: 5, image: require('./images/next.png'), index: '8 of 10' },
  { label: 'Next Stretch', time: 5, image: require('./images/next.png'), index: '8 of 10' },
  { label: 'Wall Dog', time: 30, image: require('./images/Wall-Dog.png'), index: '9 of 10' },
  { label: 'Next Stretch', time: 5, image: require('./images/next.png'), index: '9 of 10' },
  { label: 'Next Stretch', time: 5, image: require('./images/next.png'), index: '9 of 10' },
  { label: 'Doorway Pecs', time: 30, image: require('./images/Doorway-Pecs.png'), index: '10 of 10' },
];

const Shoulders1StretchScreen = ({ navigation }) => {
  ...
  const goBack = async () => {
    try {
      navigation.navigate('Shoulders1');
    } catch (error) {
...
export default Shoulders1StretchScreen;
