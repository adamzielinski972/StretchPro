...
const activities = [
  ...
  { label: 'Next Stretch', time: 5, image: require('./images/next.png'), index: '1 of 11' },
  { label: 'Overhead Reach', time: 30, image: require('./images/Overhead-Reach.png'), index: '2 of 11' },
  { label: 'Next Stretch', time: 5, image: require('./images/next.png'), index: '2 of 11' },
  { label: 'Next Stretch', time: 5, image: require('./images/next.png'), index: '2 of 11' },
  { label: 'Diver', time: 30, image: require('./images/Diver.png'), index: '3 of 11' },
  { label: 'Next Stretch', time: 5, image: require('./images/next.png'), index: '3 of 11' },
  { label: 'Next Stretch', time: 5, image: require('./images/next.png'), index: '3 of 11' },
  { label: 'Cactus Arms', time: 30, image: require('./images/Cactus-Arms.png'), index: '4 of 11' },
  { label: 'Next Stretch', time: 5, image: require('./images/next.png'), index: '4 of 11' },
  { label: 'Next Stretch', time: 5, image: require('./images/next.png'), index: '4 of 11' },
  { label: 'Chin Retractions', time: 30, image: require('./images/Chin-Retractions.png'), index: '5 of 11' },
  ...
  { label: 'Next Stretch', time: 5, image: require('./images/next.png'), index: '8 of 11' },
  { label: 'Scapula Stretch', time: 15, image: require('./images/Scapula-Stretch.png'), index: '9 of 11' },
  ...
  { label: 'Next Stretch', time: 5, image: require('./images/next.png'), index: '9 of 11' },
  { label: 'Scalene Stretch', time: 15, image: require('./images/Scalene-Stretch.png'), index: '10 of 11' },
...
const Neck4StretchScreen = ({ navigation }) => {
...
export default Neck4StretchScreen;
