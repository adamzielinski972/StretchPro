...
export default function LowerBack1Screen({ navigation }) {
    ...
    <SafeAreaView style={styles.safeArea}>
      ...
      <View style={styles.header}>
        ...
        <View style={styles.titleContainer}>
          <Text style={styles.titleText}>Lower Back 1</Text>
        </View>
      </View>
      ...
      <TouchableOpacity style={styles.startButton} onPress={() => navigation.navigate('LowerBack1Stretch')}>
