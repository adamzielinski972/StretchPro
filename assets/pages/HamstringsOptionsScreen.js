...
export default function HamstringsOptionsScreen({ navigation }) {
    ...
    <SafeAreaView style={styles.safeArea}>
      <View style={styles.header}>
        ...
        <View style={styles.titleContainer}>
          <Text style={styles.titleText}>Hamstrings</Text>
        </View>
      </View>
      <ScrollView contentContainerStyle={styles.scrollViewContent}>
        <StretchOption image={require('./images/Hurdler.png')} title="Hamstrings 1" length={"5 MINUTES"} onPress={()=> navigation.navigate('Hamstrings1')} />
        <StretchOption image={require('./images/Reverse-Lunge.png')} title="Hamstrings 2" length={"10 MINUTES"} onPress={()=> navigation.navigate('Hamstrings2')} />
        <StretchOption image={require('./images/Seated-Straddle.png')} title="Hamstrings 3" length={"15 MINUTES"} onPress={()=> navigation.navigate('Hamstrings3')}/>
      </ScrollView>
    </SafeAreaView>
  );
}
