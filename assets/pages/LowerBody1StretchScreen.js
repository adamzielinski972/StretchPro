...
const activities = [
  { label: 'Wide Leg Bend', time: 30, image: require('./images/Wide-Leg-Bend.png'), index: '1 of 6' },
  { label: 'Next Stretch', time: 5, image: require('./images/next.png'), index: '1 of 6' },
  { label: 'Next Stretch', time: 5, image: require('./images/next.png'), index: '1 of 6' },
  { label: 'Lunge', time: 30, image: require('./images/Lunge.png'), index: '2 of 6' },
  ...
  { label: 'Next Stretch', time: 5, image: require('./images/next.png'), index: '2 of 6' },
  { label: 'Reverse Lunge', time: 30, image: require('./images/Reverse-Lunge.png'), index: '3 of 6' },
  { label: 'Switch Sides', time: 5, image: require('./images/swap.png'), index: '3 of 6' },
  { label: 'Switch Sides', time: 5, image: require('./images/swap.png'), index: '3 of 6' },
  { label: 'Reverse Lunge', time: 30, image: require('./images/Reverse-Lunge.png'), index: '3 of 6' },
  { label: 'Next Stretch', time: 5, image: require('./images/next.png'), index: '3 of 6' },
  { label: 'Next Stretch', time: 5, image: require('./images/next.png'), index: '3 of 6' },
  { label: 'Butterfly', time: 30, image: require('./images/Butterfly.png'), index: '4 of 6' },
  ...
  { label: 'Next Stretch', time: 5, image: require('./images/next.png'), index: '5 of 6' },
  { label: 'Lying Figure Four', time: 30, image: require('./images/Lying-Figure-Four.png'), index: '6 of 6' },
...
const LowerBody1StretchScreen = ({ navigation }) => {
  ...
  const goBack = async () => {
    try {
      navigation.navigate('LowerBody1');
    } catch (error) {
...
export default LowerBody1StretchScreen;
