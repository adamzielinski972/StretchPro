...
export default function LowerBodyOptionsScreen({ navigation }) {
    ...
    <SafeAreaView style={styles.safeArea}>
      <View style={styles.header}>
        ...
        <View style={styles.titleContainer}>
          <Text style={styles.titleText}>Lower Body</Text>
        </View>
      </View>
      <ScrollView contentContainerStyle={styles.scrollViewContent}>
        <StretchOption image={require('./images/Lunge.png')} title="Lower Body 1" length={"5 MINUTES"} onPress={()=> navigation.navigate('LowerBody1')} />
        <StretchOption image={require('./images/Side-Lunge.png')} title="Lower Body 2" length={"10 MINUTES"} onPress={()=> navigation.navigate('LowerBody2')} />
        <StretchOption image={require('./images/Plow.png')} title="Lower Body 3" length={"15 MINUTES"} onPress={()=> navigation.navigate('LowerBody3')}/>
      </ScrollView>
    </SafeAreaView>
  );
}
