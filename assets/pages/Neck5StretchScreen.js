...
const activities = [
  { label: 'Neck Roll', time: 30, image: require('./images/Neck-Roll.png'), index: '1 of 11' },
  { label: 'Next Stretch', time: 5, image: require('./images/next.png'), index: '1 of 11' },
  { label: 'Next Stretch', time: 5, image: require('./images/next.png'), index: '1 of 11' },
  { label: 'Chin Retractions', time: 30, image: require('./images/Chin-Retractions.png'), index: '2 of 11' },
  { label: 'Next Stretch', time: 5, image: require('./images/next.png'), index: '2 of 11' },
  { label: 'Next Stretch', time: 5, image: require('./images/next.png'), index: '2 of 11' },
  { label: 'Neck Flex', time: 15, image: require('./images/Neck-Flex.png'), index: '3 of 11' },
  ...
  { label: 'Next Stretch', time: 5, image: require('./images/next.png'), index: '3 of 11' },
  { label: 'Neck Laterals', time: 15, image: require('./images/Neck-Laterals.png'), index: '4 of 11' },
  ...
  { label: 'Next Stretch', time: 5, image: require('./images/next.png'), index: '4 of 11' },
  { label: 'Scapula Stretch', time: 15, image: require('./images/Scapula-Stretch.png'), index: '5 of 11' },
  ...
  { label: 'Next Stretch', time: 5, image: require('./images/next.png'), index: '5 of 11' },
  { label: 'Scalene Stretch', time: 15, image: require('./images/Scalene-Stretch.png'), index: '6 of 11' },
  ...
  { label: 'Next Stretch', time: 5, image: require('./images/next.png'), index: '6 of 11' },
  { label: 'Neck Rotation', time: 15, image: require('./images/Neck-Rotation.png'), index: '7 of 11' },
  ...
  { label: 'Next Stretch', time: 5, image: require('./images/next.png'), index: '7 of 11' },
  { label: 'Doorway Pecs', time: 30, image: require('./images/Doorway-Pecs.png'), index: '8 of 11' },
  { label: 'Next Stretch', time: 5, image: require('./images/next.png'), index: '8 of 11' },
  { label: 'Next Stretch', time: 5, image: require('./images/next.png'), index: '8 of 11' },
  { label: 'One Arm Hug', time: 15, image: require('./images/One-Arm-Hug.png'), index: '9 of 11' },
  ...
  { label: 'Next Stretch', time: 5, image: require('./images/next.png'), index: '9 of 11' },
  { label: 'Overhead Tricep', time: 15, image: require('./images/Overhead-Tricep.png'), index: '10 of 11' },
  ...
  { label: 'Next Stretch', time: 5, image: require('./images/next.png'), index: '10 of 11' },
  { label: 'Reverse Shoulder', time: 30, image: require('./images/Reverse-Shoulder.png'), index: '11 of 11' },
];

const Neck5StretchScreen = ({ navigation }) => {
...
export default Neck5StretchScreen;
