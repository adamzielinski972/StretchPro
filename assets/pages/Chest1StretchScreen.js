...
const activities = [
  { label: 'Arm Swings', time: 30, image: require('./images/Arm-Swings.png'), index: '1 of 8' },
  { label: 'Next Stretch', time: 5, image: require('./images/next.png'), index: '1 of 8' },
  { label: 'Next Stretch', time: 5, image: require('./images/next.png'), index: '1 of 8' },
  { label: 'Chest Opener', time: 30, image: require('./images/Chest-Opener.png'), index: '2 of 8' },
  { label: 'Next Stretch', time: 5, image: require('./images/next.png'), index: '2 of 8' },
  { label: 'Next Stretch', time: 5, image: require('./images/next.png'), index: '2 of 8' },
  { label: 'Overhead Tricep', time: 15, image: require('./images/Overhead-Tricep.png'), index: '3 of 8' },
  ...
  { label: 'Next Stretch', time: 5, image: require('./images/next.png'), index: '3 of 8' },
  { label: 'One Arm Hug', time: 15, image: require('./images/One-Arm-Hug.png'), index: '4 of 8' },
  ...
  { label: 'Next Stretch', time: 5, image: require('./images/next.png'), index: '4 of 8' },
  { label: 'Wall Arms', time: 30, image: require('./images/Wall-Arms.png'), index: '5 of 8' },
  ...
  { label: 'Next Stretch', time: 5, image: require('./images/next.png'), index: '5 of 8' },
  { label: 'Wall Pecs', time: 30, image: require('./images/Wall-Pecs.png'), index: '6 of 8' },
  ...
  { label: 'Next Stretch', time: 5, image: require('./images/next.png'), index: '6 of 8' },
  { label: 'Doorway Pecs', time: 30, image: require('./images/Doorway-Pecs.png'), index: '7 of 8' },
  { label: 'Next Stretch', time: 5, image: require('./images/next.png'), index: '7 of 8' },
  { label: 'Next Stretch', time: 5, image: require('./images/next.png'), index: '7 of 8' },
  { label: 'Reverse Shoulder', time: 30, image: require('./images/Reverse-Shoulder.png'), index: '8 of 8' },
];

const Chest1StretchScreen = ({ navigation }) => {
...
export default Chest1StretchScreen;
