...
const activities = [
  { label: 'Upward Salute', time: 30, image: require('./images/Upward-Salute.png'), index: '1 of 8' },
  { label: 'Next Stretch', time: 5, image: require('./images/next.png'), index: '1 of 8' },
  { label: 'Next Stretch', time: 5, image: require('./images/next.png'), index: '1 of 8' },
  { label: 'Toe Touch', time: 30, image: require('./images/Toe-Touch.png'), index: '2 of 8' },
  ...
  { label: 'Next Stretch', time: 5, image: require('./images/next.png'), index: '3 of 8' },
  { label: 'Upward Dog', time: 30, image: require('./images/Upward-Dog.png'), index: '4 of 8' },
  { label: 'Next Stretch', time: 5, image: require('./images/next.png'), index: '4 of 8' },
  { label: 'Next Stretch', time: 5, image: require('./images/next.png'), index: '4 of 8' },
  { label: "Child's Pose", time: 30, image: require('./images/Child-Pose.png'), index: '5 of 8' },
  { label: 'Next Stretch', time: 5, image: require('./images/next.png'), index: '5 of 8' },
  { label: 'Next Stretch', time: 5, image: require('./images/next.png'), index: '5 of 8' },
  { label: 'Downward Dog', time: 30, image: require('./images/Downward-Dog.png'), index: '6 of 8' },
  { label: 'Next Stretch', time: 5, image: require('./images/next.png'), index: '6 of 8' },
  { label: 'Next Stretch', time: 5, image: require('./images/next.png'), index: '6 of 8' },
  { label: 'Wide Leg Bend', time: 30, image: require('./images/Wide-Leg-Bend.png'), index: '7 of 8' },
  { label: 'Next Stretch', time: 5, image: require('./images/next.png'), index: '7 of 8' },
  { label: 'Next Stretch', time: 5, image: require('./images/next.png'), index: '7 of 8' },
  { label: 'Upward Salute', time: 30, image: require('./images/Upward-Salute.png'), index: '8 of 8' },
];

const WakeUpStretchScreen = ({ navigation }) => {
...
export default WakeUpStretchScreen;
