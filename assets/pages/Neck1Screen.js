...
export default function Neck1Screen({ navigation }) {
    ...
    <SafeAreaView style={styles.safeArea}>
      ...
      <View style={styles.header}>
        ...
        <View style={styles.titleContainer}>
          <Text style={styles.titleText}>Neck 1</Text>
        </View>
      </View>
      <ScrollView contentContainerStyle={styles.scrollViewContent}>
        ...
        <Stretch image={require('./images/Diver.png')} title="Diver" length={"0:15"} onPress={() => handlePress(require('./images/Diver.png'), "Diver", "Sitting down in a chair, lock your hands and stretch your arms out in front of your body. Spread your shoulder blades, tuck your head forward, and round your back.")}/>
        <Stretch image={require('./images/Cactus-Arms.png')} title="Cactus Arms" length={"0:15"} onPress={() => handlePress(require('./images/Cactus-Arms.png'), "Cactus Arms", "Sitting with your back straight, raise your arms out to each side and lift them up half way. Pin back your shoulders, keep your palms facing forward, and lengthen the spine by leaning your head and neck forward.")}/>
      ...
      <TouchableOpacity style={styles.startButton} onPress={() => navigation.navigate('Neck1Stretch')}>
