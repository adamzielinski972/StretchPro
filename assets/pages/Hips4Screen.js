...
export default function Hips4Screen({ navigation }) {
    ...
    <SafeAreaView style={styles.safeArea}>
      ...
      <View style={styles.header}>
        ...
        <View style={styles.titleContainer}>
          <Text style={styles.titleText}>Hips 4</Text>
        </View>
      </View>
      <ScrollView contentContainerStyle={styles.scrollViewContent}>
        ...
        <Stretch image={require('./images/Leaning-Figure-Four.png')} title="Leaning Figure Four" length={"1:00"} onPress={() => handlePress(require('./images/Leaning-Figure-Four.png'), "Leaning Figure Four", "Start by sitting on the floor with your knees bent and your feet flat on the ground. Place your hands behind you to support your body and keep your back straight. Cross one leg over the other so your ankle is resting on the knee of your lower leg and your other foot is flat on the floor. Open your chest and extend your spine upwards." )} />
      ...
      <TouchableOpacity style={styles.startButton} onPress={() => navigation.navigate('Hips4Stretch')}>
