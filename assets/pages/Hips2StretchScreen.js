...
const activities = [
  { label: 'Lunge', time: 30, image: require('./images/Lunge.png'), index: '1 of 11' },
  { label: 'Switch Sides', time: 5, image: require('./images/swap.png'), index: '1 of 11' },
  { label: 'Switch Sides', time: 5, image: require('./images/swap.png'), index: '1 of 11' },
  { label: 'Lunge', time: 30, image: require('./images/Lunge.png'), index: '1 of 11' },
  { label: 'Next Stretch', time: 5, image: require('./images/next.png'), index: '1 of 11' },
  { label: 'Next Stretch', time: 5, image: require('./images/next.png'), index: '1 of 11' },
  { label: 'Reverse Lunge', time: 30, image: require('./images/Reverse-Lunge.png'), index: '2 of 11' },
  { label: 'Switch Sides', time: 5, image: require('./images/swap.png'), index: '2 of 11' },
  { label: 'Switch Sides', time: 5, image: require('./images/swap.png'), index: '2 of 11' },
  { label: 'Reverse Lunge', time: 30, image: require('./images/Reverse-Lunge.png'), index: '2 of 11' },
  { label: 'Next Stretch', time: 5, image: require('./images/next.png'), index: '2 of 11' },
  { label: 'Next Stretch', time: 5, image: require('./images/next.png'), index: '2 of 11' },
  { label: 'Side Lunge', time: 30, image: require('./images/Side-Lunge.png'), index: '3 of 11' },
  { label: 'Switch Sides', time: 5, image: require('./images/swap.png'), index: '3 of 11' },
  { label: 'Switch Sides', time: 5, image: require('./images/swap.png'), index: '3 of 11' },
  { label: 'Side Lunge', time: 30, image: require('./images/Side-Lunge.png'), index: '3 of 11' },
  { label: 'Next Stretch', time: 5, image: require('./images/next.png'), index: '3 of 11' },
  { label: 'Next Stretch', time: 5, image: require('./images/next.png'), index: '3 of 11' },
  { label: 'Lizard Pose', time: 30, image: require('./images/Lizard-Pose.png'), index: '4 of 11' },
  { label: 'Switch Sides', time: 5, image: require('./images/swap.png'), index: '4 of 11' },
  { label: 'Switch Sides', time: 5, image: require('./images/swap.png'), index: '4 of 11' },
  { label: 'Lizard Pose', time: 30, image: require('./images/Lizard-Pose.png'), index: '4 of 11' },
  { label: 'Next Stretch', time: 5, image: require('./images/next.png'), index: '4 of 11' },
  { label: 'Next Stretch', time: 5, image: require('./images/next.png'), index: '4 of 11' },
  { label: 'Pigeon', time: 30, image: require('./images/Pigeon.png'), index: '5 of 11' },
  { label: 'Switch Sides', time: 5, image: require('./images/swap.png'), index: '5 of 11' },
  { label: 'Switch Sides', time: 5, image: require('./images/swap.png'), index: '5 of 11' },
  { label: 'Pigeon', time: 30, image: require('./images/Pigeon.png'), index: '5 of 11' },
  { label: 'Next Stretch', time: 5, image: require('./images/next.png'), index: '5 of 11' },
  { label: 'Next Stretch', time: 5, image: require('./images/next.png'), index: '5 of 11' },
  { label: 'Hurdler', time: 30, image: require('./images/Hurdler.png'), index: '6 of 11' },
  { label: 'Switch Sides', time: 5, image: require('./images/swap.png'), index: '6 of 11' },
  { label: 'Switch Sides', time: 5, image: require('./images/swap.png'), index: '6 of 11' },
  { label: 'Hurdler', time: 30, image: require('./images/Hurdler.png'), index: '6 of 11' },
  { label: 'Next Stretch', time: 5, image: require('./images/next.png'), index: '6 of 11' },
  { label: 'Next Stretch', time: 5, image: require('./images/next.png'), index: '6 of 11' },
  { label: 'Quad Stretch', time: 30, image: require('./images/Quad-Stretch.png'), index: '7 of 11' },
  { label: 'Switch Sides', time: 5, image: require('./images/swap.png'), index: '7 of 11' },
  { label: 'Switch Sides', time: 5, image: require('./images/swap.png'), index: '7 of 11' },
  { label: 'Quad Stretch', time: 30, image: require('./images/Quad-Stretch.png'), index: '7 of 11' },
  { label: 'Next Stretch', time: 5, image: require('./images/next.png'), index: '7 of 11' },
  { label: 'Next Stretch', time: 5, image: require('./images/next.png'), index: '7 of 11' },
  { label: 'Lying Figure Four', time: 30, image: require('./images/Lying-Figure-Four.png'), index: '8 of 11' },
  ...
  { label: 'Next Stretch', time: 5, image: require('./images/next.png'), index: '8 of 11' },
  { label: 'Spinal Twist', time: 30, image: require('./images/Spinal-Twist.png'), index: '9 of 11' },
  ...
  { label: 'Next Stretch', time: 5, image: require('./images/next.png'), index: '9 of 11' },
  { label: 'Reclined Butterfly', time: 30, image: require('./images/Reclined-Butterfly.png'), index: '10 of 11' },
  { label: 'Next Stretch', time: 5, image: require('./images/next.png'), index: '10 of 11' },
  { label: 'Next Stretch', time: 5, image: require('./images/next.png'), index: '10 of 11' },
  { label: 'Happy Baby', time: 30, image: require('./images/Happy-Baby.png'), index: '11 of 11' },
];

const Hips2StretchScreen = ({ navigation }) => {
...
export default Hips2StretchScreen;
