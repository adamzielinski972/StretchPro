...
export default function Neck3Screen({ navigation }) {
    ...
    <SafeAreaView style={styles.safeArea}>
      ...
      <View style={styles.header}>
        ...
        <View style={styles.titleContainer}>
          <Text style={styles.titleText}>Neck 3</Text>
        </View>
      </View>
      ...
      <TouchableOpacity style={styles.startButton} onPress={() => navigation.navigate('Neck3Stretch')}>
