...
export default function QuadricepsOptionsScreen({ navigation }) {
    ...
    <SafeAreaView style={styles.safeArea}>
      <View style={styles.header}>
        ...
        <View style={styles.titleContainer}>
          <Text style={styles.titleText}>Quadriceps</Text>
        </View>
      </View>
      <ScrollView contentContainerStyle={styles.scrollViewContent}>
        <StretchOption image={require('./images/Standing-Quad.png')} title="Quads 1" length={"5 MINUTES"} onPress={()=> navigation.navigate('Quadriceps1')} />
        <StretchOption image={require('./images/Lunge.png')} title="Quads 2" length={"10 MINUTES"} onPress={()=> navigation.navigate('Quadriceps2')} />
        <StretchOption image={require('./images/Kneeling-Quad.png')} title="Quads 3" length={"15 MINUTES"} onPress={()=> navigation.navigate('Quadriceps3')}/>
      </ScrollView>
    </SafeAreaView>
  );
}
