...
export default function LowerBack5Screen({ navigation }) {
    ...
    <SafeAreaView style={styles.safeArea}>
      ...
      <View style={styles.header}>
        ...
        <View style={styles.titleContainer}>
          <Text style={styles.titleText}>Lower Back 5</Text>
        </View>
      </View>
      <ScrollView contentContainerStyle={styles.scrollViewContent}>
        ...
        <Stretch image={require('./images/Elbow-Side-Plank.png')} title="Elbow Side Plank" length={"1:00"} onPress={() => handlePress(require('./images/Elbow-Side-Plank.png'), "Elbow Side Plank", "Lying on your left side with your legs straight and feet stacked on top of each other, place your left elbow under your left shoulder. Engage your core to lift your hips up off the floor so that you’re supporting your weight on your left elbow and the side of your left foot. Keep your body in a straight line and place your right hand on your hip or lift it up toward the ceiling." )} />
        <Stretch image={require('./images/Figure-Four-Twist.png')} title="Figure Four Twist" length={"1:00"} onPress={() => handlePress(require('./images/Figure-Four-Twist.png'), "Figure Four Twist", "Start by lying on your back with knees bent and feet flat on the floor. Cross one leg over the other so your foot is resting on the knee of your lower leg and your other foot is flat on the floor. Next, let your legs fall to the side so that the top foot comes to the floor and the bottom leg rests on its side." )} />
      </ScrollView>
      <TouchableOpacity style={styles.startButton} onPress={() => navigation.navigate('LowerBack5Stretch')}>
