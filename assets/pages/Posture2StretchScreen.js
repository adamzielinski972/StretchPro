...
const activities = [
  { label: 'Pelvic Tilt Press', time: 15, image: require('./images/Pelvic-Tilt-Press.png'), index: '1 of 11' },
  { label: 'Next Stretch', time: 5, image: require('./images/next.png'), index: '1 of 11' },
  { label: 'Next Stretch', time: 5, image: require('./images/next.png'), index: '1 of 11' },
  { label: 'Bridge', time: 15, image: require('./images/Bridge.png'), index: '2 of 11' },
  { label: 'Next Stretch', time: 5, image: require('./images/next.png'), index: '2 of 11' },
  { label: 'Next Stretch', time: 5, image: require('./images/next.png'), index: '2 of 11' },
  { label: 'Knees To Chest', time: 30, image: require('./images/Knees-To-Chest.png'), index: '3 of 11' },
  { label: 'Next Stretch', time: 5, image: require('./images/next.png'), index: '3 of 11' },
  { label: 'Next Stretch', time: 5, image: require('./images/next.png'), index: '3 of 11' },
  { label: 'Single Knee To Chest', time: 30, image: require('./images/Single-Knee-To-Chest.png'), index: '4 of 11' },
  ...
  { label: 'Next Stretch', time: 5, image: require('./images/next.png'), index: '4 of 11' },
  { label: 'Lying Quad Stretch', time: 30, image: require('./images/Lying-Quad-Stretch.png'), index: '5 of 11' },
  ...
  { label: 'Next Stretch', time: 5, image: require('./images/next.png'), index: '5 of 11' },
  { label: 'Lunge', time: 30, image: require('./images/Lunge.png'), index: '6 of 11' },
  ...
  { label: 'Next Stretch', time: 5, image: require('./images/next.png'), index: '6 of 11' },
  { label: 'Cat Cow', time: 30, image: require('./images/Cat-Cow.png'), index: '7 of 11' },
  { label: 'Next Stretch', time: 5, image: require('./images/next.png'), index: '7 of 11' },
  { label: 'Next Stretch', time: 5, image: require('./images/next.png'), index: '7 of 11' },
  { label: 'Butterfly', time: 30, image: require('./images/Butterfly.png'), index: '8 of 11' },
  { label: 'Next Stretch', time: 5, image: require('./images/next.png'), index: '8 of 11' },
  { label: 'Next Stretch', time: 5, image: require('./images/next.png'), index: '8 of 11' },
  { label: 'Lying Figure Four', time: 30, image: require('./images/Lying-Figure-Four.png'), index: '9 of 11' },
  ...
  { label: 'Next Stretch', time: 5, image: require('./images/next.png'), index: '9 of 11' },
  { label: 'Pelvic Tilt Press', time: 15, image: require('./images/Pelvic-Tilt-Press.png'), index: '10 of 11' },
  { label: 'Next Stretch', time: 5, image: require('./images/next.png'), index: '10 of 11' },
  { label: 'Next Stretch', time: 5, image: require('./images/next.png'), index: '10 of 11' },
  { label: 'Bridge', time: 15, image: require('./images/Bridge.png'), index: '11 of 11' },
];

const Posture2StretchScreen = ({ navigation }) => {
...
export default Posture2StretchScreen;
