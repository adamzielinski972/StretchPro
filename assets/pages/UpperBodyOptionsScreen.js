...
export default function UpperBodyOptionsScreen({ navigation }) {
    ...
    <SafeAreaView style={styles.safeArea}>
      <View style={styles.header}>
        ...
        <View style={styles.titleContainer}>
          <Text style={styles.titleText}>Upper Body</Text>
        </View>
      </View>
      <ScrollView contentContainerStyle={styles.scrollViewContent}>
        <StretchOption image={require('./images/Chin-Retractions.png')} title="Upper Body 1" length={"5 MINUTES"} onPress={()=> navigation.navigate('UpperBody1')} />
        <StretchOption image={require('./images/Bear-Hug.png')} title="Upper Body 2" length={"10 MINUTES"} onPress={()=> navigation.navigate('UpperBody2')} />
        <StretchOption image={require('./images/Cow-Face.png')} title="Upper Body 3" length={"15 MINUTES"} onPress={()=> navigation.navigate('UpperBody3')}/>
      </ScrollView>
    </SafeAreaView>
  );
}
