...
const activities = [
  { label: 'Lunge', time: 30, image: require('./images/Lunge.png'), index: '1 of 7' },
  { label: 'Switch Sides', time: 5, image: require('./images/swap.png'), index: '1 of 7' },
  { label: 'Switch Sides', time: 5, image: require('./images/swap.png'), index: '1 of 7' },
  { label: 'Lunge', time: 30, image: require('./images/Lunge.png'), index: '1 of 7' },
  { label: 'Next Stretch', time: 5, image: require('./images/next.png'), index: '1 of 7' },
  { label: 'Next Stretch', time: 5, image: require('./images/next.png'), index: '1 of 7' },
  { label: 'Reverse Lunge', time: 30, image: require('./images/Reverse-Lunge.png'), index: '2 of 7' },
  ...
  { label: 'Next Stretch', time: 5, image: require('./images/next.png'), index: '3 of 7' },
  { label: 'Butterfly', time: 30, image: require('./images/Butterfly.png'), index: '4 of 7' },
  { label: 'Next Stretch', time: 5, image: require('./images/next.png'), index: '4 of 7' },
  { label: 'Next Stretch', time: 5, image: require('./images/next.png'), index: '4 of 7' },
  { label: 'Lying Figure Four', time: 30, image: require('./images/Lying-Figure-Four.png'), index: '5 of 7' },
  ...
  { label: 'Next Stretch', time: 5, image: require('./images/next.png'), index: '5 of 7' },
  { label: 'Quad Stretch', time: 30, image: require('./images/Quad-Stretch.png'), index: '6 of 7' },
  ...
  { label: 'Next Stretch', time: 5, image: require('./images/next.png'), index: '6 of 7' },
  { label: 'Spinal Twist', time: 30, image: require('./images/Spinal-Twist.png'), index: '7 of 7' },
...
const Hips5StretchScreen = ({ navigation }) => {
...
export default Hips5StretchScreen;
