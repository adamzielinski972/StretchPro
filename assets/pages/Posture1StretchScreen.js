...
const activities = [
  { label: 'Chin Retractions', time: 15, image: require('./images/Chin-Retractions.png'), index: '1 of 10' },
  { label: 'Next Stretch', time: 5, image: require('./images/next.png'), index: '1 of 10' },
  { label: 'Next Stretch', time: 5, image: require('./images/next.png'), index: '1 of 10' },
  { label: 'Wall Pecs', time: 30, image: require('./images/Wall-Pecs.png'), index: '2 of 10' },
  ...
  { label: 'Next Stretch', time: 5, image: require('./images/next.png'), index: '2 of 10' },
  { label: 'Upward Salute', time: 30, image: require('./images/Upward-Salute.png'), index: '3 of 10' },
  { label: 'Next Stretch', time: 5, image: require('./images/next.png'), index: '3 of 10' },
  { label: 'Next Stretch', time: 5, image: require('./images/next.png'), index: '3 of 10' },
  { label: 'Chin Retractions', time: 15, image: require('./images/Chin-Retractions.png'), index: '4 of 10' },
  { label: 'Next Stretch', time: 5, image: require('./images/next.png'), index: '4 of 10' },
  { label: 'Next Stretch', time: 5, image: require('./images/next.png'), index: '4 of 10' },
  { label: 'Wall Dog', time: 30, image: require('./images/Wall-Dog.png'), index: '5 of 10' },
  { label: 'Next Stretch', time: 5, image: require('./images/next.png'), index: '5 of 10' },
  { label: 'Next Stretch', time: 5, image: require('./images/next.png'), index: '5 of 10' },
  { label: 'Doorway Pecs', time: 30, image: require('./images/Doorway-Pecs.png'), index: '6 of 10' },
  { label: 'Next Stretch', time: 5, image: require('./images/next.png'), index: '6 of 10' },
  { label: 'Next Stretch', time: 5, image: require('./images/next.png'), index: '6 of 10' },
  { label: 'One Arm Hug', time: 15, image: require('./images/One-Arm-Hug.png'), index: '7 of 10' },
  ...
  { label: 'Next Stretch', time: 5, image: require('./images/next.png'), index: '7 of 10' },
  { label: 'Reverse Shoulder', time: 30, image: require('./images/Reverse-Shoulder.png'), index: '8 of 10' },
  { label: 'Next Stretch', time: 5, image: require('./images/next.png'), index: '8 of 10' },
  { label: 'Next Stretch', time: 5, image: require('./images/next.png'), index: '8 of 10' },
  { label: 'Neck Laterals', time: 15, image: require('./images/Neck-Laterals.png'), index: '9 of 10' },
  ...
  { label: 'Next Stretch', time: 5, image: require('./images/next.png'), index: '9 of 10' },
  { label: 'Chin Retractions', time: 15, image: require('./images/Chin-Retractions.png'), index: '10 of 10' },
];

const Posture1StretchScreen = ({ navigation }) => {
...
export default Posture1StretchScreen;
