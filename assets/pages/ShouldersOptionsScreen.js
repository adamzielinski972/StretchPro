...
export default function ShouldersOptionsScreen({ navigation }) {
    ...
    <SafeAreaView style={styles.safeArea}>
      <View style={styles.header}>
        ...
        <View style={styles.titleContainer}>
          <Text style={styles.titleText}>Shoulders</Text>
        </View>
      </View>
      <ScrollView contentContainerStyle={styles.scrollViewContent}>
        <StretchOption image={require('./images/Reverse-Shoulder.png')} title="Shoulders 1" length={"5 MINUTES"} onPress={()=> navigation.navigate('Shoulders1')} />
        <StretchOption image={require('./images/Forward-Fold.png')} title="Shoulders 2" length={"10 MINUTES"} onPress={()=> navigation.navigate('Shoulders2')} />
        <StretchOption image={require('./images/Seated-Chest.png')} title="Shoulders 3" length={"15 MINUTES"} onPress={()=> navigation.navigate('Shoulders3')}/>
      </ScrollView>
    </SafeAreaView>
  );
}
