...
export default function LowerBack6Screen({ navigation }) {
    ...
    <SafeAreaView style={styles.safeArea}>
      ...
      <View style={styles.header}>
        ...
        <View style={styles.titleContainer}>
          <Text style={styles.titleText}>Lower Back 6</Text>
        </View>
      </View>
      <ScrollView contentContainerStyle={styles.scrollViewContent}>
        ...
        <Stretch image={require('./images/Elbow-Plank.png')} title="Elbow Plank" length={"0:30"} onPress={() => handlePress(require('./images/Elbow-Plank.png'), "Elbow Plank", "Start on your hands and knees. Bring your left knee up to your left hand, rotating your leg so that your left foot is as close to your right hand as possible. Keep your left knee pointed out at 45 degrees away from your body and extend your right leg straight back behind you. Gently fold forward over your left knee so your elbows are on the floor." )} />
      ...
      <TouchableOpacity style={styles.startButton} onPress={() => navigation.navigate('LowerBack6Stretch')}>
