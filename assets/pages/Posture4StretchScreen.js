...
const activities = [
  { label: 'Squat Hold', time: 30, image: require('./images/Squat-Hold.png'), index: '1 of 4' },
  { label: 'Next Stretch', time: 5, image: require('./images/next.png'), index: '1 of 4' },
  { label: 'Next Stretch', time: 5, image: require('./images/next.png'), index: '1 of 4' },
  { label: 'Split Lunge Hold', time: 60, image: require('./images/Split-Lunge-Hold.png'), index: '2 of 4' },
  { label: 'Next Stretch', time: 5, image: require('./images/next.png'), index: '2 of 4' },
  { label: 'Next Stretch', time: 5, image: require('./images/next.png'), index: '2 of 4' },
  { label: 'Side Lunge Hold', time: 30, image: require('./images/Side-Lunge-Hold.png'), index: '3 of 4' },
  { label: 'Switch Sides', time: 5, image: require('./images/swap.png'), index: '3 of 4' },
  { label: 'Switch Sides', time: 5, image: require('./images/swap.png'), index: '3 of 4' },
  { label: 'Side Lunge Hold', time: 30, image: require('./images/Side-Lunge-Hold.png'), index: '3 of 4' },
  { label: 'Next Stretch', time: 5, image: require('./images/next.png'), index: '3 of 4' },
  { label: 'Next Stretch', time: 5, image: require('./images/next.png'), index: '3 of 4' },
  { label: 'Wall Sit', time: 30, image: require('./images/Wall-Sit.png'), index: '4 of 4' },
];

const Posture4StretchScreen = ({ navigation }) => {
...
export default Posture4StretchScreen;
