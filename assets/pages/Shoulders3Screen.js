    ...
    <SafeAreaView style={styles.safeArea}>
      ...
      <View style={styles.header}>
        ...
        <View style={styles.titleContainer}>
          <Text style={styles.titleText}>Shoulders 3</Text>
        </View>
      </View>
      <ScrollView contentContainerStyle={styles.scrollViewContent}>
        ...
        <Stretch image={require('./images/Shoulder-Cross.png')} title="Shoulder Cross" length={"1:00"} onPress={() => handlePress(require('./images/Shoulder-Cross.png'), "Shoulder Cross", "Start lying on your stomach with your arms in front of you. Lift your upper body slightly off the floor and move your left arm to the right side of your body beneath your right arm. Lower your head and upper body to the floor, tucking your left shoulder beneath your chin. Crawl your right arm forward to further the stretch.")}/>
        <Stretch image={require('./images/Shoulder-Opener.png')} title="Shoulder Opener" length={"1:00"} onPress={() => handlePress(require('./images/Shoulder-Opener.png'), "Shoulder Opener", "Start lying on your stomach with your arms out. Place your right hand on the floor to push your right hip open and right leg over your body so that your right foot lands behind your left leg. Walk your right leg back to open your hips and further the stretch in your left shoulder.")}/>
        <Stretch image={require('./images/Seated-Chest.png')} title="Seated Chest" length={"0:30"} onPress={() => handlePress(require('./images/Seated-Chest.png'), "Seated Chest", "Start by sitting on the floor with your knees bent and your feet flat on the floor. Place your palms on the floor behind you with your fingers pointing away from your body. Keeping your legs in place, slowly slide your hands away from your body. Keep your neck and shoulders relaxed and back off if you feel any sharp pain.")}/>

      </ScrollView>
      <TouchableOpacity style={styles.startButton} onPress={() => navigation.navigate('Shoulders3Stretch')}>
