...
const activities = [
  { label: 'Lizard Pose', time: 30, image: require('./images/Lizard-Pose.png'), index: '1 of 8' },
  { label: 'Switch Sides', time: 5, image: require('./images/swap.png'), index: '1 of 8' },
  { label: 'Switch Sides', time: 5, image: require('./images/swap.png'), index: '1 of 8' },
  { label: 'Lizard Pose', time: 30, image: require('./images/Lizard-Pose.png'), index: '1 of 8' },
  { label: 'Next Stretch', time: 5, image: require('./images/next.png'), index: '1 of 8' },
  { label: 'Next Stretch', time: 5, image: require('./images/next.png'), index: '1 of 8' },
  { label: 'Frog Pose', time: 30, image: require('./images/Frog-Pose.png'), index: '2 of 8' },
  { label: 'Next Stretch', time: 5, image: require('./images/next.png'), index: '2 of 8' },
  { label: 'Next Stretch', time: 5, image: require('./images/next.png'), index: '2 of 8' },
  { label: 'Pigeon', time: 30, image: require('./images/Pigeon.png'), index: '3 of 8' },
  { label: 'Switch Sides', time: 5, image: require('./images/swap.png'), index: '3 of 8' },
  { label: 'Switch Sides', time: 5, image: require('./images/swap.png'), index: '3 of 8' },
  { label: 'Pigeon', time: 30, image: require('./images/Pigeon.png'), index: '3 of 8' },
  { label: 'Next Stretch', time: 5, image: require('./images/next.png'), index: '3 of 8' },
  { label: 'Next Stretch', time: 5, image: require('./images/next.png'), index: '3 of 8' },
  { label: 'Lying Side Leg Raise', time: 15, image: require('./images/Lying-Side-Leg-Raise.png'), index: '4 of 8' },
  ...
  { label: 'Next Stretch', time: 5, image: require('./images/next.png'), index: '4 of 8' },
  { label: 'Leaning 90/90', time: 30, image: require('./images/Leaning-9090.png'), index: '5 of 8' },
  ...
  { label: 'Next Stretch', time: 5, image: require('./images/next.png'), index: '5 of 8' },
  { label: 'Bicycle Crunch Hold', time: 15, image: require('./images/Bicycle-Crunch-Hold.png'), index: '6 of 8' },
  { label: 'Switch Sides', time: 5, image: require('./images/swap.png'), index: '6 of 8' },
  { label: 'Switch Sides', time: 5, image: require('./images/swap.png'), index: '6 of 8' },
  { label: 'Bicycle Crunch Hold', time: 15, image: require('./images/Bicycle-Crunch-Hold.png'), index: '6 of 8' },
  { label: 'Next Stretch', time: 5, image: require('./images/next.png'), index: '6 of 8' },
  { label: 'Next Stretch', time: 5, image: require('./images/next.png'), index: '6 of 8' },
  { label: 'Seated Straddle', time: 30, image: require('./images/Seated-Straddle.png'), index: '7 of 8' },
  { label: 'Next Stretch', time: 5, image: require('./images/next.png'), index: '7 of 8' },
  { label: 'Next Stretch', time: 5, image: require('./images/next.png'), index: '7 of 8' },
  { label: 'Knees To Chest', time: 30, image: require('./images/Knees-To-Chest.png'), index: '8 of 8' },
];

const Hips6StretchScreen = ({ navigation }) => {
...
export default Hips6StretchScreen;
