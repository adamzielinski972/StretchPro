...
export default function FullBodyScreen({ navigation }) {
    ...
    <SafeAreaView style={styles.safeArea}>
      ...
      <View style={styles.header}>
        ...
        <View style={styles.titleContainer}>
          <Text style={styles.titleText}>Full Body</Text>
        </View>
      </View>
      <ScrollView contentContainerStyle={styles.scrollViewContent}>
        ...
        <Stretch image={require('./images/Side-Lunge.png')} title="Side Lunge" length={"0:30"} onPress={() => handlePress(require('./images/Side-Lunge.png'), "Side Lunge", "Start standing with a wide stance and a slight bend in your knees. Keeping your back and torso upright, shift your body weight to your right leg, bending your knee until your right thigh is parallel with the floor. Keep your left leg straight and your arms extended out in front of you or on your hips.")}/>
        ...
        <Stretch image={require('./images/Seated-Twist.png')} title="Seated Twist" length={"1:00"} onPress={() => handlePress(require('./images/Seated-Twist.png'), "Seated Twist", "Sitting upright with your legs in front of you, cross your right leg over your left, placing your right foot next to your left thigh. Hook your left arm around your right knee and reach your right arm behind you, gently twisting your body to the right.")}/>
        ...
        <Stretch image={require('./images/Lying-Figure-Four.png')} title="Lying Figure Four" length={"0:30"} onPress={() => handlePress(require('./images/Lying-Figure-Four.png'), "Lying Figure Four", "Lying on your back with knees bent and feet flat on the floor, cross your left ankle over your right knee and grab the back of the right knee with both hands. Pull your right leg toward your chest while keeping your lower back on the floor.")}/>
        <Stretch image={require('./images/Lying-Hamstring.png')} title="Lying Hamstring" length={"1:00"} onPress={() => handlePress(require('./images/Lying-Hamstring.png'), "Lying Hamstring", "Lying on your back with knees bent and feet flat on the floor, raise your right leg up and grab the back of your right knee with both hands, pulling the leg toward the chest. Grab your calf or foot if possible and straighten your right leg to further the stretch.")}/>
        ...
        <Stretch image={require('./images/Spinal-Twist.png')} title="Spinal Twist" length={"0:30"} onPress={() => handlePress(require('./images/Spinal-Twist.png'), "Spinal Twist", "Starting flat on your back, shift your hips to the right and bring your right leg over your left, placing your left hand on the outside of your right knee.")}/>
        <Stretch image={require('./images/Quad-Stretch.png')} title="Quad Stretch" length={"0:30"} onPress={() => handlePress(require('./images/Quad-Stretch.png'), "Quad Stretch", "Start sitting on the floor with your legs extended straight out in front of you. Bend your knee and grab your foot to bring it back behind you, placing your foot directly underneath your buttocks. Gently lean back to rest on your elbows.")}/>
        ...
        <Stretch image={require('./images/Seated-Fold.png')} title="Seated Fold" length={"0:30"} onPress={() => handlePress(require('./images/Seated-Fold.png'), "Seated Fold", "Start from a seated position with your legs extended straight out in front of you. Keeping your back straight, fold forward at the hips and reach your hands toward your feet.")}/>
      ...
      <TouchableOpacity style={styles.startButton} onPress={() => navigation.navigate('FullBodyStretch')}>
