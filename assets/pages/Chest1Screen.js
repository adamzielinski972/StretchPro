...
export default function Chest1Screen({ navigation }) {
    ...
    <SafeAreaView style={styles.safeArea}>
      ...
      <View style={styles.header}>
        ...
        <View style={styles.titleContainer}>
          <Text style={styles.titleText}>Chest 1</Text>
        </View>
      </View>
      ...
      <TouchableOpacity style={styles.startButton} onPress={() => navigation.navigate('Chest1Stretch')}>
