...
export default function ChestOptionsScreen({ navigation }) {
    ...
    <SafeAreaView style={styles.safeArea}>
      <View style={styles.header}>
        ...
        <View style={styles.titleContainer}>
          <Text style={styles.titleText}>Chest</Text>
        </View>
      </View>
      <ScrollView contentContainerStyle={styles.scrollViewContent}>
        <StretchOption image={require('./images/Chest-Opener.png')} title="Chest 1" length={"5 MINUTES"} onPress={()=> navigation.navigate('Chest1')} />
        <StretchOption image={require('./images/Wall-Arms.png')} title="Chest 2" length={"10 MINUTES"} onPress={()=> navigation.navigate('Chest2')} />
        <StretchOption image={require('./images/Seated-Chest.png')} title="Chest 3" length={"15 MINUTES"} onPress={()=> navigation.navigate('Chest3')}/>
      </ScrollView>
    </SafeAreaView>
  );
}
