...
export default function NeckOptionsScreen({ navigation }) {
    ...
    <SafeAreaView style={styles.safeArea}>
      <View style={styles.header}>
        ...
        <View style={styles.titleContainer}>
          <Text style={styles.titleText}>Neck</Text>
        </View>
      </View>
      <ScrollView contentContainerStyle={styles.scrollViewContent}>
        <StretchOption image={require('./images/Neck-Roll.png')} title="Neck 1" length={"4 MINUTES"} onPress={()=> navigation.navigate('Neck1')} />
        <StretchOption image={require('./images/Scapula-Stretch.png')} title="Neck 2" length={"8 MINUTES"} onPress={()=> navigation.navigate('Neck2')} />
        <StretchOption image={require('./images/Chin-Retractions.png')} title="Neck 3" length={"12 MINUTES"} onPress={()=> navigation.navigate('Neck3')}/>
        <StretchOption image={require('./images/Neck-Flexion.png')} title="Neck 4" length={"5 MINUTES"} onPress={()=> navigation.navigate('Neck4')}/>
        <StretchOption image={require('./images/Scalene-Stretch.png')} title="Neck 5" length={"5 MINUTES"} onPress={()=> navigation.navigate('Neck5')}/>
      </ScrollView>
    </SafeAreaView>
  );
}
